...
public class data_item {
    ...
    data_item(){
        data = new object_item[]{
                new object_item(R.drawable.admin,null, true, new object_item[]{
                ...
                new object_item(R.drawable.sex_offender,"http://www.icrimewatch.net/index.php?AgencyID=54758", false, null),                       //Sex Offender Registry Link
                new object_item(R.drawable.corrections,"https://www.tippecanoe.in.gov/359/Sheriffs-Department", true, new object_item[]{
                ...
                new object_item(R.drawable.submit_a_tip,"", false, null),                                                                          //Another Page
                new object_item(R.drawable.contact,"", false, null),                                                                               //Another Page
                new object_item(R.drawable.services,"https://www.tippecanoe.in.gov/359/Sheriffs-Department", true, new object_item[]{
                ...
                new object_item(R.drawable.social_media,"https://www.tippecanoe.in.gov/359/Sheriffs-Department", true, new object_item[]{
                ...
                new object_item(R.drawable.enforcement,"https://www.tippecanoe.in.gov/359/Sheriffs-Department", true, new object_item[]{
