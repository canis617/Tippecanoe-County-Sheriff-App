...
public class DataItem{
    ...
    public DataItem(Context context){
        ...
        data = new ButtonItem[]{
                ...
                new ButtonItem("Sex Offender",R.drawable.sex_offender,new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.icrimewatch.net/index.php?AgencyID=54758")),null , ButtonType.LINKTOWEB, null),                       //Sex Offender Registry Link
                ...
                new ButtonItem("We-Tip",R.drawable.we_tip,new Intent(Intent.ACTION_VIEW, Uri.parse("https://wetip.com/")), null ,ButtonType.LINKTOWEB, null),                                                                           //Another Page
